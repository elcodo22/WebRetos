...
export function RetoTitleNav({ numero, titulo }: RetoTitleNavProps) {
  return (
    <h1 className="flex min-w-0 max-w-[min(100%,42rem)] flex-wrap items-baseline justify-center gap-x-2.5 gap-y-1 px-2 text-center text-[clamp(18px,3.4vw,26px)] font-normal uppercase leading-tight tracking-wide md:gap-x-3 md:leading-none">
