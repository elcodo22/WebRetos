...
export const authFieldClassName =
  "max-w-[min(100%,36rem)] bg-transparent text-center text-[clamp(16px,3.2vw,20px)] font-normal tracking-wide text-white outline-none placeholder:text-white/[0.72] [field-sizing:content]";
